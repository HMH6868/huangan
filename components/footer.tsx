    ...
    <footer className="bg-navy-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <Image src="/logo.png" alt="HN Tea Logo" width={40} height={40} className="rounded-full" />
              <span className="text-xl font-bold">HN Tea</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">info@hntea.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2024 HN Tea. Tất cả quyền được bảo lưu.</p>
